...
| UI-05 | Mobile menu exposes every nav item, theme toggle, logout | positive | P3 | **E2E** | Nav is `Overview, Pages, Shared, Meta, Videos, Catalog, Problems, Collections, Localization, Infrastructure, Account` (`admin-nav-config.ts`). Home and About are edited under Pages. |
