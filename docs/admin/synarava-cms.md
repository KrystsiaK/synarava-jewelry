...
- **Expand in place:** Pages (DB titles) and Shared (header main links + storefront copy groups, including the contact CTA). Catalog stays a leaf (while product authoring is paused, nav code is `SYNC` and the page is pull-only).
