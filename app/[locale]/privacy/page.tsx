...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { url: localePath(locale, "/privacy"), ...base },
  };
}
...
export default async function PrivacyPage() {
  ...
  if (locale === "pt") {
    return <PortuguesePrivacyPolicy legalName={legalName} postalAddress={postalAddress} privacyEmail={privacyEmail} homeHref={homeHref} offerHref={offerHref} />;
  }
