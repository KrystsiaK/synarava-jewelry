...
export const PAGE_FIELD_REGISTRY: EntityFieldRegistry = {
  ...
  fields: [
    ...
    { key: "calloutEyebrow", label: "Callout eyebrow", mode: "localized", required: "optional", kind: "short-text", shopifyTarget: metaobject("page_section_copy", "callout_eyebrow") },
    { key: "calloutHeading", label: "Callout heading", mode: "localized", required: "optional", kind: "short-text", shopifyTarget: metaobject("page_section_copy", "callout_heading") },
    { key: "calloutCtaHref", label: "Callout CTA href", mode: "localized", required: "optional", kind: "short-text", shopifyTarget: metaobject("page_section_copy", "callout_cta_href") },
    ...
    { key: "finalSecondaryCtaHref", label: "Final secondary CTA href", mode: "localized", required: "optional", kind: "short-text", shopifyTarget: metaobject("page_section_copy", "final_secondary_cta_href") },
